...
import bulb from "./../assets/Creative1.png"
    ...
    return (
        <section id="home" className="home">
            <div className="container">
                ...
                <img src={star}  alt="starPhoto"  className="starPhoto" id="starPhoto1" />
                <img src={bulb} alt="bulbphoto" className="bulbPhoto" /> 
                <img src={star1}  alt="starPhoto" className="starPhoto" id="starPhoto2"/>
                ...
                <div className="paragraphs">
                   ...
                   <span><Button variant="contained" className='button' >Contained</Button></span> <span> <img src={star1}  alt="starPhoto" className="starPhoto3"/></span>
                </div>
                <div className="timer" >
